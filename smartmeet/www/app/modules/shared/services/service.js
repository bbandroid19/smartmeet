angular.module('smartmeetApp')
    .service('Service', function (ENV, $http, $q, cordovaService, $rootScope) {
        this.meeting_obj = [];
        this.username = "";
        this.accountname = "";
        this.userId = "";
        ...
        this.getMeetingData = function () {
            ...
            var searchUrl = "https://share.ey.net" + "/_api/search/query?querytext='" + queryText + "'" + "&sortlist='Created:descending'&selectproperties='SMNameOWSTEXT,SMDescriptionOWSMTXT,SMOrganiserOWSUSER,SMAttendeesOWSUSER,SMStartDateOWSDATE,SMEnddateOWSDATE,SMExpirationDateOWSDATE,SMOrganiserOWSUSER,SMIsExpiredOWSCHCS,SMIsPublishedOWSCHCS,SMSeldatesOWSMTXT,SMLocatorOWSTEXT,SMTZNameOWSTEXT,AuthorOWSUSER'";
