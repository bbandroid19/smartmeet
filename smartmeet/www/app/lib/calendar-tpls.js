...
angular.module("template/rcalendar/calendar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/calendar.html",
    ...
    "        </div>\n" +
    "        <div class=\"calendar-header col-xs-8\"><button type=\"button\" class=\"btn btn-default btn-sm\" ng-click=\"move(-1)\"><i\n" +
    "                    class=\"fa fa-chevron-left\"></i></button>\n"+
    "                   {{title | uppercase}} <button type=\"button\" class=\"btn btn-default btn-sm\" ng-click=\"move(1)\"><i\n" +
...
angular.module("template/rcalendar/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/month.html",
    ...
    "           <div ng-if=\"selectedDate.events\" class=\"calender_surr_date\"><div>{{currentSelection}}</div></div>\n"+   
    "            <div class=\"table table-bordered table-striped table-fixed\">\n" +
    "                <div ng-repeat=\"event in selectedDate.events\" ng-if=\"selectedDate.events\">\n" +
    "                    <div ng-if=\"!event.allDay; $index==0 \" ng-click=\"eventSelected({event:event})\" class=\"col-xs-4 monthview-eventdetail-timecolumn\">{{event.startTime |amDateFormat:'DD'}}\n" +
    "                        \n"+
    "                    </div>\n" +
    "                   <div class=\"col-xs-8 event_detail_wrap\">\n"+                 
    "                    <div ng-if=\"event.allDay\" class=\"monthview-eventdetail-timecolumn\">All day</div>\n" +
    "                    <div class=\"event-detail\" ng-click=\"eventSelected({event:event})\">{{event.title }}</div>\n" +
    "                   </div>\n"+                 
    "                </div>\n" +
    "                <div ng-if=\"!selectedDate.events\"><div class=\"no-event-label\">No Events</div></div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>");
