...
angular.module("ngProgress.provider", ["ngProgress.directive"]).service("ngProgress", function () {
    ...
    var c = {
        ...
        template: '<div ng-show="showProgress" id="ngProgress-container" ng-class="{download:downloading}"><div id="ngProgress"> <div  id="progressText" > {{progressText}} {{count | number:0}}%..</div></div></div>'
    };
    return c
