...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.events = {
      ".annotator-adder div click": "onAdderClick",
      ".annotator-adder div mousedown": "onAdderMousedown",
      ".annotator-hl mouseover": "onHighlightMouseover",
      ".annotator-hl mouseout": "startViewerHideTimer"
    };

    Annotator.prototype.html = {
      adder: '<div class="annotator-adder"><div>' + _t('Annotate') + '</div></div>',
  ...
  if (((_ref1 = g.document) != null ? _ref1.evaluate : void 0) == null) {
    $.getScript('https://share.ey.net/sites/SMARTMeet/SiteAssets/scripts/pdfjs/xpath.min.js');
  }

  if (g.getSelection == null) {
    $.getScript('https://share.ey.net/sites/SMARTMeet/SiteAssets/scripts/pdfjs/ierange.min.js');
  }

  if (g.JSON == null) {
    $.getScript('https://share.ey.net/sites/SMARTMeet/SiteAssets/scripts/pdfjs/json2.min.js');
  }
  ...
  Annotator.Viewer = (function(_super) {
    ...
    Viewer.prototype.html = {
      ...
      item: "<li class=\"annotator-annotation annotator-item\">\n  <span class=\"annotator-controls\">\n    <a href=\"#\" title=\"View as webpage\" class=\"annotator-link\">View as webpage</a>\n    <div title=\"Edit\" class=\"annotator-edit\">Edit</div>\n    <div title=\"Delete\" class=\"annotator-delete\">Delete</div>\n  </span>\n</li>"
    };
  ...
  Annotator.Plugin.Filter = (function(_super) {
    ...
    Filter.prototype.html = {
      element: "<div class=\"annotator-filter\">\n  <strong>" + Annotator._t('Navigate:') + "</strong>\n<span class=\"annotator-filter-navigation\">\n  <div class=\"annotator-filter-previous\">" + Annotator._t('Previous') + "</div>\n<div class=\"annotator-filter-next\">" + Annotator._t('Next') + "</div>\n</span>\n<strong>" + Annotator._t('Filter by:') + "</strong>\n</div>",
      filter: "<span class=\"annotator-filter-property\">\n  <label></label>\n  <input/>\n  <div class=\"annotator-filter-clear\">" + Annotator._t('Clear') + "</div>\n</span>"
    };
